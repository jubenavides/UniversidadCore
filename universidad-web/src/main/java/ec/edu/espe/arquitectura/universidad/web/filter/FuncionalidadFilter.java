    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (session != null && session.isLoggedIn()) {
                ...
                List<SegPerfilFuncionalidad> listaFuncionalidades = segPerfilFuncionalidadService.obtenerPorCodigoPerfil(session.getCodPerfil());
                for (SegPerfilFuncionalidad funcionalidad : listaFuncionalidades) {
                    if (requestHttp.getRequestURI().compareTo(requestHttp.getContextPath() +"/pp/"+ funcionalidad.getSegFuncionalidad().getUrl()) == 0) {
                        loginRequest = true;
                        break;
                    }
                }
                ...
                httpResponse.sendRedirect(requestHttp.getContextPath() + "/index.xhtml");
            }
        } catch (Throwable t) {
